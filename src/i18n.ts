...
const STRINGS: Record<Lang, Record<string, string>> = {
  ...
  cardDesc4Ball: 'Score when your cue ball contacts both red balls — order or cushions do not matter.',
    ...
    back: 'Back',
    reset: 'Reset',
    confirmRestart: 'Restart game?',
    confirmRestartMessage: 'Current scores and ball positions will be lost.',
    cancel: 'Cancel',
    player1: 'Player 1',
    player2: 'Player 2',
    ai: 'AI',
  ...
  cardDesc4Ball: '내 공이 빨간 공 두 개를 모두 맞히면 득점합니다(순서·쿠션 무관).',
    ...
    back: '뒤로',
    reset: '초기화',
    confirmRestart: '게임을 다시 시작할까요?',
    confirmRestartMessage: '현재 점수와 공 위치가 초기화됩니다.',
    cancel: '취소',
    player1: '플레이어1',
    player2: '플레이어2',
    ai: 'AI',
